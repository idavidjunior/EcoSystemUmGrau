---
tags: [apagar, decisao, limpar, opencode, teclado, virgula]
...
impacto: Novo painel simplesCalcPage dentro do FrameLayout; tabBar ganhou um 5o botao; switchTab estendido para gerenciar visibilidade/alpha/background do indice 4. Nenhuma aba existente teve o indice alterado (posicao anexada no fim para minimo impacto). Ressources novos gerado
## Conexoes
