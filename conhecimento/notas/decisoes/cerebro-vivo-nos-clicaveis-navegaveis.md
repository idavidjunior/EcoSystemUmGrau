---
tags: [abrir, conectados, decisao, lista, navegar, opencode]
aliases: [cerebro vivo nos clicaveis navegaveis]
date: 2026-08-30
---
...
impacto: Interação mais rica e navegável no grafo; abertura de arquivo movida do clique para o botão do painel. Sem mudança na estrutura de dados nem regressão no preflight (
## Conexoes
