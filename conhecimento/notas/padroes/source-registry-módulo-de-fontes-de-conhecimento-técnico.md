---
tags: [engine, fonte, knowle, memory, opencodeopencode, padrao]
...
decisao: Criar módulo source_registry.py para carregar/buscar fontes do catálogo YAML, integrando com knowle
## Conexoes
