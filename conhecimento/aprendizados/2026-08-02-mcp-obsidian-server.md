...
2. Teste de cada tool:
   - `vault-summary` → `{"total_notes": 330, docs: 3, conhecimento: 327, documentos: 0}`
   - `search-vault "tts prosody"` → 18 hits com excertos reais
   - `read-note docs/jarvis-arquitetura.md` → conteúdo completo da nota
   - `list-vault conhecimento/aprendizados recursive` → 59 notas listadas
