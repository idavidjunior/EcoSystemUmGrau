...
(function(){
  ...
  // Usa movementX/Y (delta real entre eventos) para evitar problemas com
  // screenX/screenY que retornam 0 no WebView2. Eventos em window para
  // capturar mesmo quando o mouse sai da janela durante o arrasto.
  var dragging=false, msx=0, msy=0;
  document.getElementById('drag').addEventListener('mousedown', function(e){
    dragging=true;
    msx=window.__winPosX||0; msy=window.__winPosY||0;
    e.preventDefault();
  });
