...
<script>
  ...
  (function(){
    ...
    flashGroup.appendChild(mkEl('span', 'font-size:10px;color:' + cores.texto2 + ';'));
    flashGroup.firstChild.textContent = 'Flash';
    ...
    topBar.style.cssText =
      'position:fixed;top:10px;right:12px;left:52px;z-index:99998;' +
      'display:flex;justify-content:flex-end;align-items:center;gap:6px;';
    layoutGroup.appendChild(btnReset);
    topBar.appendChild(layoutGroup);
