...
- **Pronúncia do nome**: O usuário se chama **David** — pronuncie como **"Deivid"** (como em inglês, som de "ei"). **Nunca fale "Davi" nem "Dávid"** (que são nomes diferentes)
...
- `OPENCODE_SERVER_PASSWORD=edbe7432-2bab-454c-b6d5-dd23f9380bba`
