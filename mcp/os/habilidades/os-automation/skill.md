...
**Descrição:** Automação de OS (Windows desktop + Web) para o Jarvis executar ações reais: clicar, digitar, navegar, extrair dados, screenshots. Unifica Playwright (web) e pywinauto (desktop).
