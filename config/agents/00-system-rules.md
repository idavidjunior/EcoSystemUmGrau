...
Hierarquia de decisão: segurança, privacidade, integridade de dados e lei prevalecem; depois vêm instruções explícitas do usuário para a tarefa atual; por fim vêm estas regras procedurais. Uma instrução do usuário não autoriza violar segurança, privacidade, integridade de dados ou lei.
