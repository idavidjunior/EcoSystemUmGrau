# -*- coding: utf-8 -*-
"""
Adaptive Timeout Manager — gerenciamento adaptativo de timeouts.
Padrao: LER adaptative timeouts + atomic persistence.
"""
import time
import json
import os
...
class AdaptiveTimeoutManager:
    ...
    def _atomic_write(self, data: Dict, path: str):
        ...
        try:
            ...
            print(f"[AdaptiveTimeoutManager] Erro na escrita atomica: {e}")
