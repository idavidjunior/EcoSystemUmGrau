...
**Exportado em:** 2026-08-08T18:18:17.633247
**Projetos:** 4
**Padroes Tecnicos:** 85
**Decisoes:** 57
**Bug Fixes:** 52
...
| 76 |  | Config: # 2026-07-28: Formato correto do MCP no OpenCode 1.18.7 |
...
| 80 |  | 2026-08-03: ADB remoto via Tailscale - script automatico de rota (IPv4/IPv6) |
...
**Versao do grafo:** 2
**Ultima atualizacao:** 2026-08-08T18:18:17.584785
