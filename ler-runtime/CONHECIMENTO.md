...
**Exportado em:** 2026-08-24T08:38:40.001236
**Projetos:** 4
**Padroes Tecnicos:** 283
**Decisoes:** 75
**Bug Fixes:** 52
...
| 87 |  | Compreensao de pedidos: refino com a LLM do opencode (primaria) + backups |
| 88 | opencode | mvp streamumgrau flutter supabase |
| 89 |  | eco agente e comando global |
...
| 252 | opencode+opencode+opencode+opencode+opencode | padrao organizacao comandos |
...
| 279 | opencode+opencode+opencode+opencode+opencode | @ecow e /ecow — abrir/focar o Cerebro Vivo |
...
**Versao do grafo:** 2
**Ultima atualizacao:** 2026-08-24T08:38:39.923710
