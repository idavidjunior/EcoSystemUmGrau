...
**Exportado em:** 2026-08-24T01:37:53.329834
**Projetos:** 4
...
| 87 |  | Compreensao de pedidos: refino com a LLM do opencode (primaria) + backups |
| 88 | opencode | mvp streamumgrau flutter supabase |
| 89 |  | eco agente e comando global |
...
| 252 | opencode+opencode+opencode+opencode | padrao organizacao comandos |
...
| 278 | opencode+opencode+opencode | CLI-Anything Internalizado como Habilidade Soberana |
| 279 | opencode+opencode+opencode+opencode | @ecow e /ecow — abrir/focar o Cerebro Vivo |
...
**Versao do grafo:** 2
**Ultima atualizacao:** 2026-08-24T01:37:53.246013
