...
**Exportado em:** 2026-08-10T21:03:00.508445
**Projetos:** 4
...
| 76 |  | Config: # 2026-07-28: Formato correto do MCP no OpenCode 1.18.7 |
...
| 80 |  | 2026-08-03: ADB remoto via Tailscale - script automatico de rota (IPv4/IPv6) |
...
| 87 |  | Compreensao de pedidos: refino com a LLM do opencode (primaria) + backups |
| 88 | opencode | mvp streamumgrau flutter supabase |
| 89 |  | eco agente e comando global |
...
| 95 |  | Projetos irmaos do EcoSystemUmGrau |
...
| 99 |  | Aprendizado: Skill auditoria-de-codigo (auto-evolutiva) |
| 100 | opencode | Aprendizado: Skill auditoria-de-codigo viva com evolução gated |
| 101 |  | Aprendizado: Jarvis manifesta o que quer aprender |
...
**Versao do grafo:** 2
**Ultima atualizacao:** 2026-08-10T21:03:00.399374
